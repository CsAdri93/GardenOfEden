  ...
  return (
    <div className="p-5 m-auto text-center content img-up">
      ...
      >
        ...
        <p>Bármilyen gondba,hibába ütközik kérem forduljon hozzánk bizalommal!</p>

        <h5>A legfontosabb tudnivalók:</h5>
        <div className="row mt-3">
          <div className=" col-auto col-md-auto col-lg-4 col-xl-3 mx-auto mb-4">
            <br />
            <h6 className="fw-bold mb-4">Kosárbatevés:</h6>
          ...
          <div className=" col-auto col-md-auto col-lg-4 col-xl-3 mx-auto mb-4">
            <br></br>
            <h6 className="fw-bold mb-4">Fizetés:</h6>
          ...
          <div className=" col-auto col-md-auto col-lg-4 col-xl-3 mx-auto mb-4">
            <br />
            <h6 className="fw-bold mb-4">Szállítás:</h6>

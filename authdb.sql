...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Ápr 25. 17:46
...
-- Adatbázis: `authdb`
--
CREATE DATABASE IF NOT EXISTS `authdb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `authdb`;
...
('25cd34ca-ed5d-4441-8ba8-c5782052a4a2', 'Naár Csaba', 0, 'f3NY1t0', 'F3NY1T0', 'naarcs@kkszki.hu', 'NAARCS@KKSZKI.HU', 0, 'AQAAAAIAAYagAAAAEKe4sX6++XZCqarxF60wUZG3chMxiY2pdytcNf4PQ2qbLB4AIZTVg7CaeoT2hJIDfg==', 'CISR4A2MRE3J4FZSIPWUXZDBAOYXILXH', 'a63b64ca-b27b-4e36-a1fe-10d44a1a030a', NULL, 0, 0, NULL, 1, 0);
